...
Agents4Career is a Sherlock Holmes-inspired multi-agent system for job application optimization. It consists of four specialized AI agents that work together to analyze job descriptions, develop resume strategies, generate tailored CVs, and maintain a knowledge base.

## Agent Architecture

The system uses four Claude-based agents, each with specific responsibilities:
...
4. **Maintenance Phase**: Hudson updates the knowledge base with new information/feedback
